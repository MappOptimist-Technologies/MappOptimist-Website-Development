        ...
        <div className="client-review-big-circle">
          <div className="client-review-big-circle-inside">
            <div className="client-review-profile-block-outside">
              <img src={reviewImg1.src} alt="Clients reviews about the MappOptimist Technologies" />
            </div>
            <div className="client-review-profile-block-outside">
              <img src={reviewImg2.src} alt="Clients reviews about the MappOptimist Technologies" />
            </div>
            <div className="client-review-profile-block-outside">
              <img src={reviewImg3.src} alt="Clients reviews about the MappOptimist Technologies" />
            </div>
          </div>
        </div>
        <div className="client-review-circle">
          <div className="client-review-profile-block">
            <img src={reviewImg4.src} alt="Clients reviews about the MappOptimist Technologies" />
          </div>
          <div className="client-review-profile-block">
            <img src={reviewImg5.src} alt="Clients reviews about the MappOptimist Technologies" />
          </div>
          <div className="client-review-profile-block">
            <img src={reviewImg6.src} alt="Clients reviews about the MappOptimist Technologies" />
          </div>
        </div>
              ...
              <div key={`company-reviews-${item?.name}-${index}`} className="py-4">
                <div className="reviewer-comment-container">
                  ...
                  <div className="reviewer-profile">
                    <img src={item?.img?.src} height="48" width="48" alt={item?.name + " " + item?.comment} />
                  </div>
                </div>
              </div>
            ))}
