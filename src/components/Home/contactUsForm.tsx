  ...
  return (
    <section className="contact-form-section container">
      <div className='contact-form-left'>
        <h1>Let&#39;s start something incredible—connect with us today!</h1>
      </div>
      <div className='contact-form-right shadow-lg'>
        <form>
          <div className="row">
            <div className="col">
        ...
        <div className='d-flex align-items-start justify-content-start' >
          <div className="contact-us-form-upload-button shadow-sm">
            Upload Documents
            <Image src={uploadIcon} alt="icon4" width={16} height={16} className="ms-2" />
          </div>
        </div>
        ...
        <div className='d-flex align-items-end justify-content-end' >
          <div onClick={(e) => { e.preventDefault(); formik.handleSubmit(); }} className="contact-us-form-send-button shadow-sm">
            Send Message
          </div>
        </div>
      </div>
